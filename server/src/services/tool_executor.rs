        ...
        json!({
            ...
            "input_schema": {
                ...
                "properties": {
                    ...
                    "area": {"type": "string", "description": "领域/工作区，如 PM/研发/运营/生活，留空 = 未分区"},
                    "engage": {"type": "string", "enum": ["decide", "push", "do", "track", "inform"], "description": "参与模式: decide=我决定，push=我推动，do=我执行，track=我跟踪，inform=仅知会"},
        ...
        json!({
            ...
            "input_schema": {
                ...
                "properties": {
                    ...
                    "level": {"type": "string"},
                    "area": {"type": "string"},
                    "engage": {"type": "string", "enum": ["decide", "push", "do", "track", "inform"]},
                    "freq": {"type": "string"},
        ...
        json!({
            ...
            "input_schema": {
                ...
                "properties": {
                    ...
                    "area": {"type": "string", "description": "按领域/工作区精确匹配"},
                    "engage": {"type": "string", "enum": ["decide", "push", "do", "track", "inform"], "description": "按参与模式精确匹配"},
                    "status": {"type": "string", "enum": ["todo", "doing", "blocked", "done"]},
...
fn tool_create_work_task(db: &Connection, user_id: &str, input: &Value) -> Value {
    ...
    let req = CreateWorkTaskRequest {
        ...
        area: opt_string(input, "area").unwrap_or_default(),
        engage: opt_string(input, "engage").unwrap_or_else(|| "track".to_string()),
...
fn tool_update_work_task(db: &Connection, user_id: &str, input: &Value) -> Value {
    ...
    let patch = UpdateWorkTaskRequest {
        ...
        area: opt_string(input, "area"),
        engage: opt_string(input, "engage"),
