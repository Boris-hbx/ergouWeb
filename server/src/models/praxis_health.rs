...
pub const SEED_DIMS: &[(&str, &str, &str, &str, &str, &str, &str)] = &[
    // 动
    ("move", "运动", "move", "core", "habit", "分钟", "WHO ≥150min 中强度/周 + 2×力量"),
    ("sit", "久坐", "move", "core", "habit", "次", "每 45–60min 起身"),
    ("flex", "柔韧", "move", "mid", "metric", "cm", "坐位体前屈 ≥0(过脚尖)"),
    ("cardio", "心肺", "move", "watch", "metric", "", "12min 跑距/配速·年龄常模中档"),
    ("strength", "力量", "move", "watch", "metric", "次", "俯卧撑/引体·年龄常模"),
    ("power", "爆发", "move", "watch", "metric", "cm", "纵跳·年龄常模"),
    // 吃
    ("nutrition", "饮食", "eat", "core", "habit", "", "蔬果/蛋白/低加工/规律"),
    ("vitd", "维生素D", "eat", "core", "habit", "", "随餐服用(按体检 25-OH-D 定量)"),
    ("water", "饮水", "eat", "mid", "habit", "升", "每日 1.5–2L"),
    // 睡·恢复
    ("light", "光照", "rest", "core", "habit", "分钟", "每日户外 20–30min(晨光)"),
    ("recovery", "认知恢复", "rest", "core", "habit", "分钟", "每日无刺激恢复窗口"),
    ("sleep", "睡眠", "rest", "mid", "habit", "小时", "7–9h·就寝波动<1h"),
    // 体征·信号
    ("hairloss", "掉发", "sign", "mid", "signal", "", "追踪趋势(不诊断)"),
    ("digestion", "消化", "sign", "mid", "signal", "", "无反复不适"),
    ("energy", "精力", "sign", "mid", "signal", "1–5", "无持续 ≤2 / 均 ≥4"),
    ("exam", "体检", "sign", "watch", "metric", "", "25-OH-D/铁蛋白/甲状腺/血脂"),
    ("rhr", "静息心率", "sign", "watch", "metric", "bpm", "RHR<70(未接入·手动录)"),
];
